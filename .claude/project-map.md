...
| Layer | What | When |
|-------|------|------|
| **1. localhost:8088** | Semantic scan of local files via context engine | Session/career/company questions; code tasks in brain-os-mcp |
...
Full topology and per-flow sequence diagrams: `.claude/ARCHITECTURE.md`
